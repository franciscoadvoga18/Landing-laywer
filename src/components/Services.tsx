                    ...
                    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                            ...
                            <div>
                                ...
                                <h3 className="mb-2 text-xl font-bold dark:text-white">Direito Público</h3>
                                <p className="text-gray-500 dark:text-gray-400">Atuamos em questões relacionadas ao Direito Público, incluindo licitações, contratos administrativos e defesa em processos administrativos. Nossa equipe está preparada para oferecer consultoria e representação em todas as esferas governamentais. Trabalhamos para assegurar a legalidade e transparência nas relações com o poder público.</p>
                            </div>
                            <div>
                                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
